...
import { Phone, Mail, X, User, CheckCircle } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-white relative selection:bg-red-600 selection:text-white">
      ...
      <div className="fixed left-4 bottom-6 md:bottom-auto md:top-1/2 md:-translate-y-1/2 z-40 flex flex-col gap-2.5">
        <a
          href={`tel:${OFFICE_CONTACT.phone1.replace(/\s+/g, '')}`}
          className="group flex items-center justify-center bg-slate-950 border border-slate-800 hover:bg-slate-900 text-white p-3.5 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 animate-bounce-call"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white p-3.5 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 border border-emerald-500/20 animate-bounce-whatsapp"
